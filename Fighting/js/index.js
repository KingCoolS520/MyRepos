...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      var strFighting = '#countdown 3|离高考还有' + lefttime + '天!|加油!|';
      S.UI.simulate('#countdown 3|离高考还有999天!|加油!|');
    }
  ...
  function performAction(value) {
    ...
    timedAction(function (index) {
      ...
      switch (action) {
		...
		case 'author':
          S.Shape.switchShape(S.ShapeBuilder.letter('From 、然'));
          break;
        default:
          S.Shape.switchShape(S.ShapeBuilder.letter(current[0] === cmd ? '、然' : current));
      }
